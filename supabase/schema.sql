...
CREATE TABLE IF NOT EXISTS "storage"."objects" (
    ...
    "owner_id" "text",
    "user_metadata" "jsonb",
    CONSTRAINT "objects_user_metadata_width_height_required" CHECK ((("user_metadata" IS NOT NULL) AND ("jsonb_typeof"("user_metadata") = 'object'::"text") AND ("user_metadata" ? 'width'::"text") AND ("user_metadata" ? 'height'::"text") AND ("jsonb_typeof"(("user_metadata" -> 'width'::"text")) = 'number'::"text") AND ("jsonb_typeof"(("user_metadata" -> 'height'::"text")) = 'number'::"text") AND ((("user_metadata" ->> 'width'::"text"))::integer > 0) AND ((("user_metadata" ->> 'height'::"text"))::integer > 0)))
);
