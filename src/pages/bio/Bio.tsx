  ...
  return (
    <Page>
      ...
      <PageSection className="flex flex-col gap-30">
        <BioSection name="Jeff Boxell" beatleName="John Lennon" image={`${STORAGE_ROOT_URL}/bio/jeff.avif`} imageAlt="Jeff Boxell performing" floatDirection="left">
        ...
        <BioSection name="Joe Covert" beatleName="Paul McCartney" image={`${STORAGE_ROOT_URL}/bio/joe.avif`} imageAlt="Joe Covert performing" floatDirection="right">
          <p className="text-gray-800 leading-relaxed">
        ...
        <BioSection name="Aron Helm" beatleName="George Harrison" image={`${STORAGE_ROOT_URL}/bio/aron.avif`} imageAlt="Aron Helm performing" floatDirection="left">
          <p className="text-gray-800 leading-relaxed">
        ...
        <BioSection name="Kevin Fransen" beatleName="Ringo Starr" image={`${STORAGE_ROOT_URL}/bio/kevin.avif`} imageAlt="Kevin Fransen performing" floatDirection="right">
          <p className="text-gray-800 leading-relaxed">
...
function BioSection({ children, name, beatleName, image, floatDirection, imageAlt = "" }: { children: React.ReactNode, name: string, beatleName: string, image: string, floatDirection: "left" | "right", imageAlt?: string }) {
  return (
