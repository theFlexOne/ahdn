  ...
  return (
    <Page>
      ...
      <PageSection className="flex flex-col gap-30">
        <Bio name="Jeff Boxell" beatleName="John Lennon" image={`${STORAGE_URL_BASE}/bio/jeff.avif`} imageAlt="Jeff Boxell performing" floatDirection="left">
        ...
        <Bio name="Joe Covert" beatleName="Paul McCartney" image={`${STORAGE_URL_BASE}/bio/joe.avif`} imageAlt="Joe Covert performing" floatDirection="right">
          <p className="text-gray-800 leading-relaxed">
        ...
        <Bio name="Aron Helm" beatleName="George Harrison" image={`${STORAGE_URL_BASE}/bio/aron.avif`} imageAlt="Aron Helm performing" floatDirection="left">
          <p className="text-gray-800 leading-relaxed">
        ...
        <Bio name="Kevin Fransen" beatleName="Ringo Starr" image={`${STORAGE_URL_BASE}/bio/kevin.avif`} imageAlt="Kevin Fransen performing" floatDirection="right">
          <p className="text-gray-800 leading-relaxed">
