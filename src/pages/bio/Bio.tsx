  ...
  return (
    <Page>
      ...
      <PageSection className="flex flex-col gap-30">
        <BioSection name="Jeff Boxell" beatleName="John Lennon" image={"jeff.avif"} imageAlt="Jeff Boxell performing" floatDirection="left">
        ...
        <BioSection name="Joe Covert" beatleName="Paul McCartney" image={"joe.avif"} imageAlt="Joe Covert performing" floatDirection="right">
          <p className="text-gray-800 leading-relaxed">
        ...
        <BioSection name="Aron Helm" beatleName="George Harrison" image={"aron.avif"} imageAlt="Aron Helm performing" floatDirection="left">
          <p className="text-gray-800 leading-relaxed">
        ...
        <BioSection name="Kevin Fransen" beatleName="Ringo Starr" image={"kevin.avif"} imageAlt="Kevin Fransen performing" floatDirection="right">
          <p className="text-gray-800 leading-relaxed">
