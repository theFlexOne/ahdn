  ...
  return (
    <Page>
      ...
      <PageSection className="flex flex-col gap-30">
        <Bio name="Jeff Boxell" beatleName="John Lennon" image="/images/bio/jeff.jpg" imageAlt="Aron Helm performing" floatDirection="left">
        ...
        <Bio name="Joe Covert" beatleName="Paul McCartney" image="/images/bio/joe.jpg" imageAlt="Joe Covert performing" floatDirection="right">
          <p className="text-gray-800 leading-relaxed">
        ...
        <Bio name="Aron Helm" beatleName="George Harrison" image="/images/bio/aron.jpg" imageAlt="Kevin Helm performing" floatDirection="left">
          <p className="text-gray-800 leading-relaxed">
        ...
        <Bio name="Kevin Fransen" beatleName="Ringo Starr" image="/images/bio/kevin.jpg" imageAlt="Kevin Fransen performing" floatDirection="right">
          <p className="text-gray-800 leading-relaxed">
